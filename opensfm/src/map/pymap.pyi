...
class Map:
    ...
    def create_landmark(self, lm_id: str, global_position: numpy.ndarray, semantic_label: int, semantic_confidence: float) -> Landmark: ...
...
class Observation:
    def __init__(self, x: float, y: float, s: float, r: int, g: int, b: int, feature: int, segmentation: int = -1, instance: int = -1, segmentation_conf: float = -1.0) -> None: ...
