...
class Map:
    ...
    def create_landmark(self, lm_id: str, global_position: numpy.ndarray, semantic_label: int, semantic_confidence: float, semantic_uncertainty: float) -> Landmark: ...
    ...
    @overload
    def create_shot(self, arg0: str, arg1: str, arg2: str, arg3: str, arg4: numpy.asarray) -> Shot: ...
    @overload
    def create_shot(self, arg0: str, arg1: str, arg2: str, arg3: str, arg4: opensfm.pygeometry.Pose, arg5: numpy.asarray) -> Shot: ...
    @staticmethod
...
class Observation:
    def __init__(self, x: float, y: float, s: float, r: int, g: int, b: int, feature: int, segmentation: int = -1, instance: int = -1, segmentation_conf: float = -1.0, segmentation_unc: float = -1.0) -> None: ...
