...
struct Observation {
  ...
  Observation(double x, double y, double s, int r, int g, int b, int feature,
      ...
      : point(x, y),
        ...
        segmentation_uncertainty_id(segmentation_unc) {}
  bool operator==(const Observation& k) const {
    return point == k.point && scale == k.scale && color == k.color &&
           ...
           segmentation_uncertainty_id == k.segmentation_uncertainty_id;
  }
  ...
  double segmentation_uncertainty_id;
